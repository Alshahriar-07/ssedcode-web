...
VERSION = "5.0.2"
VER_TAG = "v5.0.2"
WIN_EXE = "https://github.com/Alshahriar-07/seedcode-cli/releases/download/v5.0.2/seedcode-cli-setup.exe"
SRC_ZIP = "https://github.com/Alshahriar-07/seedcode-cli/archive/refs/tags/v5.0.2.zip"
...
# Slash commands available inside a `seedcode` session (README-verified).
SLASH_COMMANDS = [
    ...
    ("/model", "Browse the live model list ('auto' = FreeModel auto-select)"),
    ("/config", "Show configuration — every provider's key and model"),
    ("/settings", "Change a setting: username, stream, ollama_host, max_tokens"),
    ("/doctor", "Diagnose config, network, and provider health"),
    ("/agent", "Toggle agent mode — the AI can read, edit, search, and run commands"),
    ("/assist", "Enable Assist Mode: unified AI + computer control"),
    ("/permission", "Set the agent permission mode: read_only, workspace, full_access"),
...
{body}
  ...
  <footer class="footer">
    <div class="container footer-grid">
      <div>
        ...
        <p class="footer-credit">Designed &amp; Developed by <strong>Eagox Studio</strong><br>
          Created by <a href="{PF}" target="_blank" rel="noopener">Al Shahriar Sowan</a> · <a href="{GH}" target="_blank" rel="noopener">GitHub</a><br>
          Vibe coded with GPT-5.5 + Claude Opus 4.8</p>
      </div>
      ...
      <nav aria-label="Resources">
        ...
        <a href="{CHAT}" target="_blank" rel="noopener">Seed Code Chat <span aria-hidden="true">→</span></a>
    ...
    <div class="container footer-bottom">
      ...
      <p>Crafted for the terminal · {VER_TAG} · <a href="{GH}/blob/main/LICENSE" rel="noopener">MIT License</a></p>
    </div>
  </footer>
...
PAGES["index.html"] = dict(
    title="Seed Code CLI v5.0.2 — AI Coding Assistant for Your Terminal",
    desc="Seed Code CLI is an AI coding assistant for your terminal. Five independent providers — OpenRouter, FreeModel Claude & Codex, AeroLink, and local Ollama. Streaming responses, Code Mode, Assist Mode, and a one-click Windows installer. Free and open source.",
    ...
    extra_head="""  <script type="application/ld+json">
  {
    ...
    "description": "The AI coding assistant for your terminal. Five providers, Code Mode, /assist desktop control, streaming responses.",
    ...
    "downloadUrl": "https://github.com/Alshahriar-07/seedcode-cli/releases/download/v5.0.2/seedcode-cli-setup.exe"
  }
  </script>
""",
      ...
      <div class="container hero-grid">
        <div class="hero-copy build-in">
          <div class="hero-badges">
            ...
            <span class="badge">{VER_TAG}</span>
            <span class="badge">MIT License</span>
          </div>
          <h1 class="words visible">The AI coding assistant, inside your <span class="accent-word">terminal</span>.</h1>
          <p class="hero-sub">Fast, elegant, and built for developers. Five independent providers — <strong>OpenRouter</strong>, <strong>FreeModel Claude</strong>, <strong>FreeModel Codex</strong>, <strong>AeroLink</strong>, or fully local <strong>Ollama</strong> — with streaming responses and a terminal experience polished down to the last character.</p>
          <div class="hero-actions">
            <a href="{WIN_EXE}" class="btn btn-primary btn-lg" data-magnetic>{DL_ICON} Download Seed Code v5.0.2</a>
        ...
        <div class="terminal-frame">
          <div class="terminal">
            <div class="terminal-bar">
              ...
              <span class="terminal-title">seedcode — v5.0.2</span>
              <span></span>
            </div>
    ...
    <section class="stats" data-pin aria-label="Project statistics">
      <div class="container">
        <div class="stats-grid stagger reveal">
          ...
          <div class="stat"><span class="stat-num"><span class="counter" data-target="5">0</span></span><span class="stat-label">Providers supported</span></div>
    ...
    <section class="section">
      <div class="container">
        <div class="section-head gsap-head">
          ...
          <p>Streaming AI, five providers, and a terminal UI that feels first-class.</p>
        </div>
        <div class="feature-grid stagger reveal">
          ...
          <article class="feature-card" data-tilt>
            ...
            <h3>Five Independent Providers</h3>
            <p>OpenRouter, FreeModel Claude &amp; Codex, AeroLink — or fully local and private with Ollama. Switch with <code>/provider</code>.</p>
          </article>
          <article class="feature-card" data-tilt>
    ...
    <section class="section-tight">
      <div class="container">
        <div class="section-head gsap-head">
          <span class="eyebrow">Two ways to work</span>
          <h2 data-chars>Code Mode &amp; <span class="accent-word">/assist</span></h2>
          <p>Seed Code adapts to the task — deep coding inside your project, or desktop control when you need it.</p>
        </div>
        <div class="feature-grid-2 feature-grid stagger reveal">
          <article class="feature-card" data-tilt>
            ...
            <h3>Code Mode</h3>
            <p>Project-aware coding inside your IDE workflow. Seed Code works with your project files — editing code, running development workflows, and AI-assisted programming right from the terminal you already live in.</p>
          ...
          <article class="feature-card" data-tilt>
            ...
            <h3>Assist Mode · <code>/assist</code></h3>
            <p>Control and interact with your desktop. AI-assisted computer actions — browser, keyboard, mouse, windows, and vision — for tasks beyond code editing. Turn it on with <code>/assist on</code>.</p>
    ...
    <section class="section">
      <div class="container">
        <div class="section-head gsap-head">
          <span class="eyebrow">Five providers, one CLI</span>
          <h2 data-chars>Bring your own AI</h2>
          <p>Each provider owns its API key, model, and history — so switching never loses anything. All keys are validated before they are saved.</p>
        </div>
        <div class="provider-grid stagger reveal">
          <article class="feature-card" data-tilt>
            <div class="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="5" r="2.5"/><circle cx="5" cy="19" r="2.5"/><circle cx="19" cy="19" r="2.5"/><path d="M12 7.5v4M6.5 17l4-5.5M17.5 17l-4-5.5"/></svg></div>
            <h3>OpenRouter</h3>
            <p>The full model catalogue. Free and Pro modes on one key — switch with <code>/settings mode free|pro</code>.</p>
          </article>
          <article class="feature-card" data-tilt>
          ...
          <article class="feature-card" data-tilt>
            ...
            <h3>AeroLink</h3>
            <p>Anthropic-compatible gateway. Claude-family models, fetched dynamically.</p>
          </article>
          <article class="feature-card" data-tilt>
    ...
    <section class="section-tight">
      <div class="container">
        <div class="section-head gsap-head">
          ...
          <h2 data-chars>Two ways to experience Seed Code</h2>
          <p>Powerful in the terminal, lighter in the browser — pick the workflow that fits.</p>
        </div>

        <div class="chat-flow stagger reveal">
          <div class="chat-flow-card feature-card">
            <span class="chat-flow-tag">Terminal</span>
            <h3>Seed Code CLI</h3>
            <ul class="sim-points">
              <li><span class="c-ok">▹</span> Terminal</li>
          ...
          <div class="chat-flow-mid">
            <span class="chat-flow-arrow" aria-hidden="true">↓</span>
          ...
          <div class="chat-flow-card feature-card">
            ...
            <ul class="sim-points">
              <li><span class="c-ok">▹</span> Lightweight</li>
              <li><span class="c-ok">▹</span> Web-based</li>
              <li><span class="c-ok">▹</span> Easy to access</li>
            </ul>
            <a href="{CHAT}" class="link-arrow" target="_blank" rel="noopener">Open Seed Code Chat <span aria-hidden="true">→</span></a>
          </div>
        </div>
    ...
    <section class="section-tight">
      <div class="container">
        <div class="cta reveal-scale">
          ...
          <p>Install Seed Code CLI v5.0.2 and start shipping with AI — beautifully.</p>
          <div class="hero-actions">
...
# ════════════════════════ FEATURES ════════════════════════
_feat = [
    ("Five Independent Providers", "OpenRouter, FreeModel Claude, FreeModel Codex, AeroLink, and local Ollama — each with its own API key, model, and history. Switch anytime with /provider.",
    ...
    ("Live Model Catalogue", "No model is ever hardcoded — pick from each provider's live catalogue, or let FreeModel auto-select the best one with /model auto.",
     '<path d="M8 6h13M8 12h13M8 18h13"/><path d="M3 6h.01M3 12h.01M3 18h.01"/>'),
    ("Code Mode", "Project-aware coding inside your IDE workflow — work with project files, edit code, and drive development workflows with AI-assisted programming.",
     '<path d="m8 6-6 6 6 6"/><path d="m16 6 6 6-6 6"/>'),
    ("Assist Mode · /assist", "Desktop and computer control with AI-assisted actions — browser, keyboard, mouse, windows, and vision for tasks beyond code editing.",
     '<rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/>'),
    ("Agent Tools", "Read, edit, search, and run commands in your project — /tools lists capabilities, /index shows the project tree, /permission sets access levels.",
     '<path d="M14.7 6.3a4.5 4.5 0 0 0 6 6L14 19l-4.5 1 1-4.5z"/><path d="M7 3h.01M11 3h.01M15 3h.01"/>'),
    ("Conversation Memory", "Session memory with auto-saved history — /history lists saved conversations, /reset starts fresh. History is stored per provider.",
     '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/>'),
    ("Markdown Rendering", "Rich Markdown rendered directly in your terminal — headings, lists, tables, links, and highlighted code blocks included.",
     '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M8 13h8M8 17h5"/>'),
    ("Windows Installer", "One-click seedcode-cli-setup.exe — installs Seed Code, adds seedcode to PATH, creates Start Menu shortcuts. No Python required.",
     '<rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/>'),
    ...
    ("Secure by Design", "API keys are saved only after real authenticated validation, environment variables override stored keys, and keys or content never reach the logs.",
...
PAGES["features.html"] = dict(
    title="Features — Seed Code CLI v5.0.2 | Five Providers, Code Mode & Assist Mode",
    desc="Everything a terminal-native developer needs: five independent AI providers, streaming responses, Code Mode, /assist desktop control, live model catalogues, Markdown rendering, and a one-click Windows installer.",
          ...
          <div class="qs-steps reveal-left">
            ...
            <div class="qs-step">
              ...
              <div class="qs-body">
                <h3>Launch &amp; set up</h3>
                {code_block("seedcode")}
                <p class="qs-note">First launch runs guided setup — provider, API key, model — until your first chat is ready. Keys are validated before they are saved.</p>
              </div>
            </div>
            <div class="qs-step">
              ...
              <div class="qs-body">
                <h3>Go further</h3>
                {code_block("/help")}
                <p class="qs-note">Enable project tools with <code>/agent</code>, AI + computer control with <code>/assist</code>, or manage keys with <code>/apikey</code>.</p>
              </div>
            </div>
          </div>
...
{_slash_rows}
    ...
    <section class="section-tight">
      <div class="container container-narrow">
        <div class="callout reveal"><strong>Verify:</strong> run <code>seedcode --version</code> — expected output <code>seedcode {VER_TAG}</code>. Something off? <code>/doctor</code> checks everything in one pass.</div>
      </div>
    </section>""",
)
...
PAGES["download.html"] = dict(
    title="Download — Seed Code CLI v5.0.2 for Windows, Linux & macOS",
    desc="Download Seed Code CLI v5.0.2: one-click Windows installer, ZIP package for Linux and macOS via MEGA, or install with pip / uv on any platform with Python 3.12+.",
    transition="wipe", enter="zoom",
    body=f"""    <section class="page-hero">
      <div class="container">
        <span class="eyebrow">Download</span>
        <h1 data-chars>Get Seed Code CLI</h1>
        <p>Latest release: <strong>{VER_TAG}</strong> · Every option gets you the same beautiful terminal experience.</p>
        <div class="hero-actions">
          <a href="{WIN_EXE}" class="btn btn-primary btn-lg" data-magnetic>{DL_ICON} Download Seed Code v5.0.2</a>
    ...
    <section class="section-tight">
      <div class="container">
        <div class="sim-strip reveal">
          <p><strong>Don't want to install yet?</strong> Try Seed Code Chat in your browser.</p>
        ...
        <div class="download-grid stagger reveal">
          <article class="dl-card" data-tilt>
            ...
            <h3>Windows</h3>
            <p>One-click installer for Windows Terminal, PowerShell, and cmd — adds <code>seedcode</code> to PATH with Start Menu shortcuts, no Python required.</p>
            <a class="btn btn-primary btn-block" href="{WIN_EXE}">{DL_ICON} seedcode-cli-setup.exe</a>
            <span class="dl-meta">v5.0.2 · standalone installer</span>
          </article>
          <article class="dl-card" data-tilt>
          ...
          <article class="dl-card dl-card-accent" data-tilt>
            ...
            <h3>pip / uv</h3>
            <p>Works on every platform with Python 3.12+. Installs the <code>seedcode</code> command globally.</p>
        ...
        <p class="dl-footnote reveal">Verify with <code>seedcode --version</code> · <a href="{GH}" rel="noopener">GitHub</a> · <a href="{SRC_ZIP}" rel="noopener">Source code (zip)</a> · <a href="https://pypi.org/project/seedcode-cli/" rel="noopener">PyPI</a></p>
      </div>
    </section>""",
)
...
_screens = [
    ...
    ("Configuration", "Per-provider API keys, models, and defaults.", [
    ...
    ("Themes", "Ship-ready themes tuned for contrast and long sessions.", [
        ('t-prompt', '$ '), ('t-cmd', 'seedcode\n'), ('t-label', 'you › '), ('t-cmd', '/theme midnight\n'),
        ('t-ok', '✓ Theme set to Midnight\n'), ('t-dim', 'Available: Midnight · Paper · Ember · Terminal')]),
    ("Settings", "Everything lives in one clean, versionable JSON file.", [
        ('t-prompt', '$ '), ('t-cmd', 'cat ~/.seedcode/config.json\n'), ('t-dim', '{ "active_provider": "freemodel_claude" }'),
        ('t-value', '  "providers": { ... }\n'), ('t-dim', '}')]),
]
...
PAGES["docs.html"] = dict(
    ...
    desc="Seed Code CLI documentation: installation, every command, configuration, five providers (OpenRouter, FreeModel Claude & Codex, AeroLink, Ollama), and troubleshooting.",
    transition="slide", enter="up",
    body=f"""    <div class="container docs-layout">
      ...
      <div class="docs-content">
        ...
        <section id="installation">
          ...
          <p>Requires Python 3.12 or newer. Installs straight from PyPI.</p>
...
seedcode {VER_TAG}</code></pre>
          ...
          <p>One-click <code>seedcode-cli-setup.exe</code> — installs to Program Files, adds <code>seedcode</code> to PATH, creates Start Menu shortcuts, no Python required. <a href="{WIN_EXE}" rel="noopener">Download for Windows</a>.</p>
          <h3>Linux &amp; macOS</h3>
          <p>Grab the packaged ZIP from <a href="{MEGA}" target="_blank" rel="noopener">MEGA</a> — it includes the complete package for both platforms. Helper scripts live in <code>scripts/linux/</code> and <code>scripts/macos/</code>. You can also install from the <a href="{SRC_ZIP}" rel="noopener">source archive</a> with <code>pip install .</code>.</p>
          <div class="callout"><strong>Tip:</strong> whichever method you choose, <code>/doctor</code> inside a session confirms everything is in place.</div>
        </section>
...
{{
  ...
  "max_tokens": 1024
          ...
          <h3>API keys</h3>
          <p>Keys are only saved after a real authenticated validation. For CI and containers, environment variables override stored keys: <code>OPENROUTER_API_KEY</code>, <code>FREEMODEL_API_KEY</code>, and <code>AEROLINK_API_KEY</code>.</p>
        </section>

        <section id="providers">
          <h2>Providers</h2>
          <p>Five independent backends — each owns its API key, model, connection status, and history. Switch anytime with <code>/provider</code>.</p>
          <table class="docs-table">
            <thead><tr><th>Provider</th><th>Best for</th><th>Config value</th></tr></thead>
            <tbody>
              <tr><td>OpenRouter</td><td>Full model catalogue — free and Pro modes on one key</td><td><code>openrouter</code></td></tr>
              <tr><td>FreeModel Claude</td><td>Claude-family models, live catalogue, auto-select</td><td><code>freemodel_claude</code></td></tr>
              <tr><td>FreeModel Codex</td><td>GPT/Codex models on the Responses API</td><td><code>freemodel_codex</code></td></tr>
              <tr><td>AeroLink</td><td>Anthropic-compatible gateway, dynamic model fetch</td><td><code>aerolink</code></td></tr>
              <tr><td>Ollama</td><td>Fully local, private, no API key</td><td><code>ollama</code></td></tr>
            </tbody>
          </table>
          <p>No model is ever hardcoded — browse any provider's live catalogue with <code>/model</code>. 312+ models on OpenRouter, 47+ of them free.</p>
        </section>
...
3/3 checks passed · environment healthy</code></pre>
          ...
          <pre><code>you › /agent
✓ Agent Mode ON — the AI can read, edit, search, and run commands
...
PAGES["changelog.html"] = dict(
    ...
    desc="Seed Code CLI version history and roadmap: what shipped in v5.0.2 and what's coming — plugins, MCP, voice, memory, and a desktop app.",
      ...
      <div class="container">
        <div class="timeline">
          ...
          <div class="timeline-item is-current reveal">
            <h3>{VER_TAG} <span class="tag tag-latest">Latest</span> <span class="changelog-date">2026</span></h3>
            <ul>
              <li><strong>Five providers</strong> — OpenRouter, FreeModel Claude, FreeModel Codex, AeroLink, and local Ollama — each with its own key, model, and history</li>
              <li><strong>/assist</strong> — Assist Mode with full computer control: browser, keyboard, mouse, windows, vision, OCR, and desktop automation</li>
              <li><strong>Agent Mode</strong> — the AI reads, edits, searches, and runs commands in your project, with read-only, workspace, and full-access permission levels</li>
              <li><strong>Streaming</strong> — live Markdown with syntax-highlighted code blocks in every response</li>
              <li><strong>Conversation memory</strong> — history auto-saved per provider, browsable with /history</li>
              <li><strong>Windows installer</strong> — one-click seedcode-cli-setup.exe: PATH integration, Start Menu shortcuts, no Python required</li>
            </ul>
          </div>
          <div class="timeline-item reveal">
            ...
            <ul>
              ...
              <li>Themes — Midnight, Paper, Ember, and Terminal Classic</li>
            </ul>
          </div>
...
_faqs = [
    ...
    ("Can I install using pip?", "Yes. Run <code>pip install seedcode-cli</code> with Python 3.12 or newer, then launch it with the <code>seedcode</code> command from any terminal."),
    ...
    ("Which providers are supported?", "Seed Code supports OpenRouter, FreeModel Claude, FreeModel Codex, and AeroLink out of the box, plus fully local models through Ollama. Each provider keeps its own API key, model, and conversation history — and through the FreeModel providers many models are entirely free."),
    ("How do I configure my API key?", "Run <code>seedcode</code> and use <code>/apikey</code> in the session to add keys for OpenRouter, FreeModel, or AeroLink. Everything is stored locally in <code>~/.seedcode/config.json</code>. You can also set environment variables like <code>OPENROUTER_API_KEY</code>, <code>FREEMODEL_API_KEY</code>, or <code>AEROLINK_API_KEY</code>."),
]
_faq_items = "\n".join(
...
PAGES["about.html"] = dict(
    ...
    <section class="section-tight">
      <div class="container prose">
        ...
        <p><strong>Created by:</strong> Al Shahriar Sowan · <strong>Vibe coded with</strong> GPT-5.5 + Claude Opus 4.8</p>
    ...
    <section class="section-tight">
      <div class="container prose">
        ...
        <ul>
          ...
          <li><strong>Prompts and responses</strong> travel directly between your machine and your chosen AI provider (OpenRouter, FreeModel, AeroLink, or your local Ollama instance). There are no Seed Code servers in between.</li>
